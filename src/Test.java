...
public class Test {
     ...
     * @throws Exception
     */
    public Test(String strKey) throws Exception {
    ...
    public static void main(String[] args) {
        try {
            ...
            String string = "362330199506075499";
            System.out.println(string.substring(6, 10));


            String test1 = "987654321杨";
            Test des1 = new Test();// 使用默认密钥
            ...
            String test2 = "杨123456789";
            Test des2 = new Test("leeme32nz");// 自定义密钥
